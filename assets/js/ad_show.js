...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const phoneNumber = document.getElementById('show-phone-number');
    const contactBySms = document.getElementById('contact-by-sms'); 
    const contactByWhatsapp = document.getElementById('contact-by-whatsapp');
